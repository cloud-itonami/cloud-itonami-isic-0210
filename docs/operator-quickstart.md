# Operator Quickstart — cloud-itonami-isic-0210

Shortest path from clone to a verified local dry-run for **ISIC 0210** (`cloud-itonami-isic-0210`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0210.git
cd cloud-itonami-isic-0210
```
...
- Likely source path: `forestry.governor.cljc`
